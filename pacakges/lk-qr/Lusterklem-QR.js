...
export class LusterklemQR extends LitElement{
    ...
    isCorrectErrorCorrection(character){
        let correctCharacters = ['L', 'M', 'Q', 'H'];
        if (typeof (character) !== 'string'){console.log('not string'); return false;} // should be a string
        if (character === ""  || character.length > 1 ){console.log('to short or long'); return false} // shouldn't be empty or more than 1 character
